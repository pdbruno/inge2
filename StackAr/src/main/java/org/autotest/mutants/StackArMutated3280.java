 ...
 */
public class StackArMutated3280 extends org.autotest.Stack {
    ...
    public StackArMutated3280() {
        this(org.autotest.mutants.StackArMutated3280.DEFAULT_CAPACITY);
    }

    public StackArMutated3280(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated3280 other = ((org.autotest.mutants.StackArMutated3280) (obj));
        if (true) {
            return false;
        }
