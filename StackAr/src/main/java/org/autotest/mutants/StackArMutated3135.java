 ...
 */
public class StackArMutated3135 extends org.autotest.Stack {
    ...
    public StackArMutated3135() {
        this(org.autotest.mutants.StackArMutated3135.DEFAULT_CAPACITY);
    }

    public StackArMutated3135(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated3135 other = ((org.autotest.mutants.StackArMutated3135) (obj));
        if (true) {
            return false;
        }
