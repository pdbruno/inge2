...
public class StackArMutated8359 extends org.autotest.Stack {
    ...
    public StackArMutated8359() {
        this(org.autotest.mutants.StackArMutated8359.DEFAULT_CAPACITY);
    }

    public StackArMutated8359(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
